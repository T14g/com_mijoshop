    ...
    public function get($var, $type, $id, $lang_id) {
        ...
        if (!isset($cache[$type][$id][$lang_id])) {
            ...
            if($route == 'product/product'){
                $ext_params = Mijosef::getCache()->getExtensionParams('com_mijoshop');
                if($ext_params->get('itemcategoryid_inc', '1') == "1") {
