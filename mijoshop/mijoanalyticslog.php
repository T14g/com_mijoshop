...
if(!(defined('PEAR_LOG_ALL'))) define('PEAR_LOG_ALL',      0xffffffff);    /* All messages */
if(!(defined('PEAR_LOG_NONE'))) define('PEAR_LOG_NONE',     0x00000000);    /* No message */
...
if(!(defined('PEAR_LOG_TYPE_SAPI'))) define('PEAR_LOG_TYPE_SAPI',    4); /* Use the SAPI logging handler */
