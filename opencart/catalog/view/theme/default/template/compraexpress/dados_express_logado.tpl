...
<div class="col-xs-12 col-md-8 xs-100 sm-100 md-66 lg-66 xl-66 ladoB">
...
<div style="padding-right: 5px;" class="col-xs-12 col-md-4 xs-100 sm-100 md-33 lg-33 xl-33 ladoA">
...
<?php echo (isset($jsoncliente[$campos_extras['fiscal']]) && strlen($jsoncliente[$campos_extras['fiscal']])==14)?'Nome':'Nome';?>: <?php echo strtoupper($dados_cliente['firstname']);?> <?php echo strtoupper($dados_cliente['lastname']);?><br>
Telefone: <?php echo $dados_cliente['telephone'];?><br>
<?php if(isset($jsoncliente[$campos_extras['fiscal']])){?>
<?php echo (isset($jsoncliente[$campos_extras['fiscal']]) && strlen($jsoncliente[$campos_extras['fiscal']])==14)?'CPF':'CPF';?>: <?php echo $jsoncliente[$campos_extras['fiscal']];?><br>
<?php } ?>
<br>
...
<?php echo strtoupper(($endereco_entrega['city']));?>/<?php echo strtoupper(($endereco_entrega['zone_code']));?> - <?php echo strtoupper(($endereco_entrega['postcode']));?><br>
