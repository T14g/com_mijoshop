	...
	<div class="box-product" style="margin: 2px;">
		<div style="margin-bottom: 5px; margin-right: 0px;">
            ...
            <?php if ($product['button']) { ?>
			    <div class="cart"><a onclick="addProductToCart('<?php echo $product['product_id']; ?>', '<?php echo count($product['options']); ?>');" class="<?php echo MijoShop::getButton(); ?>"><span><?php echo $button_cart; ?></span></a></div>
            <?php } ?>
        </div>
	</div>
</div>
