...
class ModelPaymentEasysocialpoints extends Model {
  	...
  	public function getMethod($address, $total) {
		...
		$file = JPATH_ROOT.'/components/com_easysocial/easysocial.php';
    ...
    public function getESPointID() {
        $query = $this->db->query("SELECT id FROM #__social_points WHERE command = 'mijoshop.gateway' AND extension = 'com_mijoshop'");
