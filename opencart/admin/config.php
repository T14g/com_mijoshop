...
if (!MijoShop::getClass()->isAdmin('joomla')) {
    $_suffix = '';
}
...
define("DIR_DOWNLOAD", JPATH_MIJOSHOP_OC.'/system/download/');
define("DIR_LOGS", JPATH_MIJOSHOP_OC.'/system/logs/');
define("DIR_CATALOG", JPATH_MIJOSHOP_OC.'/catalog/');
define('DIR_MODIFICATION', JPATH_MIJOSHOP_OC.'/system/modification/');
define('DIR_UPLOAD', JPATH_MIJOSHOP_OC.'/system/upload/');
