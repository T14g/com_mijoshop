...
class ControllerPaymentAmazonLoginPay extends Controller
{
    ...
    public function index()
    {
        ...
        if ($data['amazon_login_pay_marketplace'] == 'de') {
            $data['amazon_login_pay_language'] = 'de-DE';
            $data['sp_id']                     = 'AGGDPRPDPL7SL';
            $data['locale']                    = 'EUR';
            $data['registration_url']          = "https://sellercentral-europe.amazon.com/hz/me/sp/redirect?ld=SPEXDEAPA-OpencartPL";
        } elseif ($data['amazon_login_pay_marketplace'] == 'uk') {
            $data['amazon_login_pay_language'] = 'en-GB';
            $data['sp_id']                     = 'A1P8WV11EWOP9H';
            $data['locale']                    = 'GBP';
            $data['registration_url']          = "https://sellercentral-europe.amazon.com/hz/me/sp/redirect?ld=SPEXUKAPA-OpencartPL";
        } else {
            $data['amazon_login_pay_language'] = 'en-US';
            $data['sp_id']                     = 'A3GK1RS09H3A7D';
            $data['locale']                    = 'US';
            $data['registration_url']          = "https://sellercentral.amazon.com/hz/me/sp/redirect?ld=SPEXUSAPA-OpencartPL";
        }
