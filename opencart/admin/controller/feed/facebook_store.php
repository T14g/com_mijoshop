...
class ControllerFeedFacebookStore extends Controller {
	...
	public function index() {
        ...
        $this->document->addStyle('../opencart/admin/view/stylesheet/facebook-store.css');
        $this->document->addStyle('../opencart/admin/view/stylesheet/jquery-ui.css');
        
        $this->document->addScript('view/javascript/facebook-store/jquery-ui.js');
        $this->document->addScript('view/javascript/facebook-store/jquery-lockfixed.js');
		...
		$data['text_remove_feed'] = $this->language->get('text_remove_feed');
		$data['text_yes'] = $this->language->get('text_yes');
		$data['text_no'] = $this->language->get('text_no');

		$data['entry_app_id'] = $this->language->get('entry_app_id');
		$data['entry_show_header_category'] = $this->language->get('entry_show_header_category');
		$data['entry_show_header_search'] = $this->language->get('entry_show_header_search');
		$data['entry_show_header_currency'] = $this->language->get('entry_show_header_currency');
		$data['entry_show_header_language'] = $this->language->get('entry_show_header_language');
		$data['entry_show_footer'] = $this->language->get('entry_show_footer');
		$data['entry_show_product_description'] = $this->language->get('entry_show_product_description');
		$data['entry_show_product_price'] = $this->language->get('entry_show_product_price');
		$data['entry_show_product_rating'] = $this->language->get('entry_show_product_rating');
		$data['entry_show_addtocart'] = $this->language->get('entry_show_addtocart');
		...
		$data['data_feed'] = htmlspecialchars('<iframe src="' . HTTPS_CATALOG . 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=feed/facebook_store" frameborder="0" scrolling="no" width="810" height="1400"></iframe>');
