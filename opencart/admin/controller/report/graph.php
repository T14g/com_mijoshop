...
class ControllerReportGraph extends Controller
{
    ...
    public function index($graph)
    {
        ...
        $document->addScriptDeclaration($this->script($data));
    ...
    protected function script($data)
    {
        ...
        $script .= 'jQuery(document).ready(function() {' . chr(13);
        ...
        $script .= '    jQuery(\'#tab_toolbar dl\').removeClass(\'active\');' . chr(13);
        $script .= '    jQuery(\'#tab_toolbar dl\').addClass(\'passive\');' . chr(13);
        $script .= '    jQuery(\'#charts div\').removeClass(\'chart_active\');' . chr(13);
        $script .= '' . chr(13);
        $script .= '    jQuery(\'#chart-\' + chart).addClass(\'chart_active\');' . chr(13);
        $script .= '    jQuery(tab).removeClass(\'passive\');' . chr(13);
        $script .= '    jQuery(tab).addClass(\'active\');' . chr(13);
        ...
        foreach ($data['graph'] as $key => $value) {
            ...
            $script .= '    jQuery(\'#' . $key . '_score\').html(\'<i class="fa fa-spinner fa-spin checkout-spin fa-2x"></i>\');' . chr(13);
            $script .= '    jQuery(\'#chart-' . $key . '\').html(\'<div class="loading"><i class="fa fa-spinner fa-spin checkout-spin fa-5x"></i></div>\');' . chr(13);
            $script .= '' . chr(13);
            $script .= '    jQuery.ajax({' . chr(13);
            ...
            $script .= '' . chr(13);
            $script .= '            jQuery.plot(\'#chart-' . $key . '\', [json[\'order\']], option);' . chr(13);
            $script .= '' . chr(13);
            $script .= '            jQuery(\'#chart-' . $key . '\').bind(\'plothover\', function(event, pos, item) {' . chr(13);
            $script .= '                jQuery(\'.tooltip\').remove();' . chr(13);
            $script .= '' . chr(13);
            $script .= '                if (item) {' . chr(13);
            $script .= '                    jQuery(\'<div id="tooltip" class="tooltip top in"><div class="tooltip-arrow"></div><div class="tooltip-inner">\' + item.datapoint[1].toFixed(2) + \'</div></div>\').prependTo(\'body\');' . chr(13);
            $script .= '' . chr(13);
            $script .= '                    jQuery(\'#tooltip\').css({' . chr(13);
            $script .= '                        position: \'absolute\',' . chr(13);
            $script .= '                        left    : item.pageX - (jQuery(\'#tooltip\').outerWidth() / 2),' . chr(13);
            $script .= '                        top     : item.pageY - jQuery(\'#tooltip\').outerHeight(),' . chr(13);
            $script .= '                        pointer : \'cusror\'' . chr(13);
            $script .= '                    }).fadeIn(\'slow\');' . chr(13);
            $script .= '' . chr(13);
            $script .= '                    jQuery(\'#chart-' . $key . '\').css(\'cursor\', \'pointer\');' . chr(13);
            $script .= '                } else {' . chr(13);
            $script .= '                    jQuery(\'#chart-' . $key . '\').css(\'cursor\', \'auto\');' . chr(13);
            $script .= '                }' . chr(13);
            $script .= '            });' . chr(13);
            $script .= '' . chr(13);
            $script .= '            jQuery(\'#' . $key . '_score\').html(json[\'order\'][\'total\']);' . chr(13);
            $script .= '        },' . chr(13);
        ...
        $script .= 'jQuery(document).delegate(\'#button-export\', \'click\', function() {' . chr(13);
        ...
        $script .= '' . chr(13);
        $script .= '    jQuery(\'body\').append(html);' . chr(13);
        $script .= '' . chr(13);
        $script .= '    jQuery(\'#form-export\').submit();' . chr(13);
        $script .= '});' . chr(13);
        $script .= '' . chr(13);

        $script .= 'jQuery(document).delegate(\'#button-output\', \'click\', function() {' . chr(13);
        $script .= '    route = getURLVar(\'route\');' . chr(13);
        $script .= '' . chr(13);
        ...
        $script .= '    jQuery(\'body\').append(html);' . chr(13);
        $script .= '' . chr(13);
        $script .= '    jQuery(\'#form-output\').submit();' . chr(13);
        $script .= '});' . chr(13);
        $script .= '' . chr(13);
