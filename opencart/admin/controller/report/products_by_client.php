<?php
class ControllerReportProductsByClient extends Controller {
	var $version = "2.0.5";
	public function index() {
		$data = array();
		$this->language->load('report/products_by_client');
		...
		$this->load->model('report/products_by_client');
		$data['products'] = array();				
		
		$product_total = $this->model_report_products_by_client->getProductsByClientsTotal($data);
		$products_by_client_list = $this->model_report_products_by_client->getProductsByClients($data);

		$data["products"] = $products_by_client_list;			
		...
		$data['sort_id_product'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=op.product_id' . $url, 'SSL');
		$data['sort_name_product'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=op.name' . $url, 'SSL');
		$data['sort_client'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=fullname' . $url, 'SSL');
		$data['sort_email'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=o.email' . $url, 'SSL');
		$data['sort_quantity_purchased'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=quantity' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . '&sort=total' . $url, 'SSL');

		if (isset($this->request->get['sort'])) {
			$url .= '&sort=' . $this->request->get['sort'];
		}
		
		$data['url_export'] = $this->url->link('report/products_by_client/export', 'token=' . $this->session->data['token'].$url, 'SSL');
		$data['url_export_quanti'] = $this->url->link('report/products_by_client/exportQuanti', 'token=' . $this->session->data['token'].$url, 'SSL');

		$data['url_info'] = $this->url->link('report/products_by_client/info', 'token=' . $this->session->data['token'].$url, 'SSL');
		...
		$pagination->url = $this->url->link('report/products_by_client', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('report/products_by_client.tpl', $data));
	}
	...
	public function export() {
		...
		$this->response->setOutput($this->load->view('report/products_by_client_export.tpl', $data));
	}

	/*public function exportQuanti() {
		$data = array();
		...
		$products_by_client_list = $this->model_report_products_by_client->getProductsByClientsQuanti($data); 
		...
		$this->response->setOutput($this->load->view('report/products_by_client_exportquanti.tpl', $data));
	}*/
}
