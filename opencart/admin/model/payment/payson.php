...
class ModelPaymentPayson extends Model
{
    public function install()
    {
        $this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "payson_order` (
    ...
    {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "payson_order`;");
    }
}
