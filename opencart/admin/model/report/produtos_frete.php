<?php
class ModelReportProdutosFrete extends Model{
	public function getProdutosFretesTotal($data = array())	{	
		...
		$where = "o.shipping_address_1 != ''";		
		if(isset($data["filter_product_id"]) && !empty($data["filter_product_id"]))	{
			$where .= "AND op.product_id = {$data["filter_product_id"]}";
		}		
	...
	public function getProdutosFretes($data = array()){
		
		$sql = "SELECT o.shipping_address_1, o.shipping_address_2, o.shipping_city, o.shipping_postcode, o.shipping_zone, o.order_id, o.date_modified, op.product_id, op.name, CONCAT(coalesce(o.firstname,''), ' ', coalesce(o.lastname, '')) as fullname, o.customer_id, o.email, o.order_status_id, o.telephone, 
		(SELECT " . DB_PREFIX . "order_total.value FROM `" . DB_PREFIX . "order_total` INNER JOIN `" . DB_PREFIX . "order` ON " . DB_PREFIX . "order_total.order_id=" . DB_PREFIX . "order.order_id WHERE " . DB_PREFIX . "order.order_id= o.order_id AND ". DB_PREFIX ."order_total.code = 'shipping' LIMIT 1) AS totalFrete,
	...
	public function getProdutosFreteDetailsTotal($data)	{
	...
	public function getProdutosFreteDetails($data){
		$sql = "SELECT o.order_id, o.order_status_id, o.payment_method, o.total, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order_product` op INNER JOIN `" . DB_PREFIX . "order` o ON (op.order_id = o.order_id) where o.customer_id = {$data['customer_id']} and op.product_id = {$data['product_id']} %s ";
