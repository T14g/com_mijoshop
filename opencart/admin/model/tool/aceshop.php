...
class ModelToolAceshop extends Model {
  	...
  	public function migrateDatabase($post){
		...
		$db->run("INSERT INTO `#__mijoshop_setting` VALUES (9999, 0, 'config', 'config_mijoshop', 'a:15:{s:3:\"pid\";s:4:\"4444\";s:18:\"enable_vqmod_cache\";s:1:\"1\";s:11:\"show_header\";s:1:\"1\";s:11:\"show_footer\";s:1:\"1\";s:14:\"show_cats_menu\";s:1:\"0\";s:19:\"trigger_content_plg\";s:1:\"0\";s:12:\"fix_ie_cache\";s:1:\"0\";s:20:\"check_j_block_status\";s:1:\"0\";s:16:\"mijoshop_display\";s:1:\"0\";s:12:\"button_class\";s:15:\"btn btn-primary\";s:8:\"comments\";s:1:\"0\";s:19:\"mijosef_integration\";s:1:\"1\";s:17:\"account_sync_done\";s:1:\"1\";s:20:\"acymailling_register\";s:1:\"1\";s:20:\"acymailling_checkout\";s:1:\"1\";}', 1);", 'query');
    ...
    private function _upgradeTo153() {
        ...
        if ($column_query) {
            ...
            foreach ($customer_group_query as $customer_group) {
                $db->run("INSERT IGNORE INTO #__mijoshop_customer_group_description SET customer_group_id = '" . (int)$customer_group['customer_group_id'] . "', language_id = '" . (int)$default_language_id . "', `name` = '" . $db->run($customer_group['name'], 'escape') . "' ON DUPLICATE KEY UPDATE customer_group_id=customer_group_id", 'query');
            }
		...
		if (!$query) {
			$db->run("INSERT IGNORE INTO `#__mijoshop_setting` SET `store_id` = 0, `group` = 'config', `key` = 'config_customer_group_display', `value` = 'a:1:{i:0;s:1:\"8\";}', `serialized` = 1", 'query');
		}
    }
