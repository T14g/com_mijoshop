...
class ModelCommonUpgrade extends Model {
    ...
    public function upgrade() {
        ...
        elseif ($type == 'server') {
            $package = $utility->getPackageFromServer('index.php?option=com_mijoextensions&view=download&model=com_mijoshop&version='.$base->getMijoshopVersion().'&pid='.$base->getConfig()->get('pid'));
        }
