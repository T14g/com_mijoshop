  ...
  <tr>
    <td class="left" id="backups">
        <?php if ($restore) { ?>
            ...
            <select name="files_cache" id="files_cache" style="margin-right: 10px;">
            ...
            <a id="button-restore" class="button btnX"><span><?php echo $button_restore; ?></span></a>
            <a id="button-delete-cache" class="button btnX"><span><?php echo $button_delete; ?></span></a>
      <?php } ?>
    </td>
    <td class="right">
        ...
        <a onclick="cloneFile('<?php echo $edit_file ?>','<?php echo $filename ?>')" class="button btnX"><span>Clone</span></a>
    </td>
  </tr>
...
<div style="position: relative; margin-bottom: 2px; border: 1px solid #ccc; -webkit-border-radius: 7px 7px 0px 0px;
	...
	<div class="buttons" style="padding: 4px;">
		<a href="index.php?option=com_mijoshop&route=tool/themeeditor" class="button btnX cancel"><span><?php echo $button_cancel; ?></span></a>
