  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-exchange"></i>HikaShop Migration Tool</h3>
      </div>
...
function importCategories() {
    ...
    jQuery('#importCategories').load('index.php?option=com_mijoshop&route=tool/hikashop/importCategories');
}

function importProducts() {
    document.getElementById('importProducts').innerHTML = '<span style="color:green;">Loading...</span>';
    jQuery('#importProducts').load('index.php?option=com_mijoshop&route=tool/hikashop/importProducts');
}

function importManufacturers() {
    document.getElementById('importManufacturers').innerHTML = '<span style="color:green;">Loading...</span>';
    jQuery('#importManufacturers').load('index.php?option=com_mijoshop&route=tool/hikashop/importManufacturers');
}

function importUsers() {
    document.getElementById('importUsers').innerHTML = '<span style="color:green;">Loading...</span>';
    jQuery('#importUsers').load('index.php?option=com_mijoshop&route=tool/hikashop/importUsers');
}

function copyImages() {
    document.getElementById('copyImages').innerHTML = '<span style="color:green;">Loading...</span>';
    jQuery('#copyImages').load('index.php?option=com_mijoshop&route=tool/hikashop/copyImages');
}
-->
</script>