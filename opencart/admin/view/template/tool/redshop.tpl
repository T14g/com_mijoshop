  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="javascript::void(0);" onClick="importUserInformation();" class="btn btn-default">Import User Info</a>
        <a href="javascript::void(0);" onClick="copyImages();" class="btn btn-default">Copy Images</a>
      </div>
      <h1>redSHOP Migration Tool</h1>
      <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-exchange"></i>redSHOP Migration Tool</h3>
      </div>
