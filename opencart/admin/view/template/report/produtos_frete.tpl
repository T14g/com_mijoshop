      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <?php if ($sort == 'o.date_modified') { ?>
                <a href="<?php echo $sort_date_modified; ?>" class="<?php echo strtolower($order); ?>">Data</a>
                <?php } else { ?>
                <a href="<?php echo $sort_date_modified; ?>">Data</a>
                <?php } ?>
           </td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $product['shipping_address_1']; ?></td>
       <?php 
        ...
        ?> 
            <?php foreach ($custom_fields as $custom_field) { ?>
              <?php if ($custom_field['location'] == 'address') { ?>
               ...
               <?php } ?>
            <?php } ?>
            <td class="left"><?php echo $product['shipping_city']; ?></td>
             <td class="left"><?php echo $product['shipping_zone']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/produtos_frete&token=<?php echo $token; ?>';
