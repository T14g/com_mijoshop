<link href="view/javascript/jquery/daterangepicker/daterangepicker-bs3.css" rel="stylesheet">
<script src="view/javascript/jquery/daterangepicker/daterangepicker.js"></script>
<script src="view/javascript/jquery/flot/jquery.flot.js"></script>
<script src="view/javascript/jquery/flot/jquery.flot.resize.js"></script>
<script src="view/javascript/jquery/flot/jquery.flot.tickrotor.js"></script>
