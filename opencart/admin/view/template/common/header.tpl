...
<?php MijoShop::get('base')->addHeader(JPATH_MIJOSHOP_OC . '/admin/view/stylesheet/override.css'); ?>

<?php JHtml::_('jquery.framework'); ?>
<?php MijoShop::get('base')->addHeader(JPATH_MIJOSHOP_OC . '/admin/view/javascript/common.js', false); ?>

<link href="view/javascript/bootstrap/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
<header id="header" class="navbar navbar-static-top">
  <div id="mijoshop-search-div" class="col-sm-4 col-md-4 pull-left">
    <?php echo $search; ?>
  </div>
