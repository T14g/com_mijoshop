      ...
      <div class="panel-body">
        <table align="center" width="600">
          <tr>
              ...
              <td class="column-css">
                  <a href="http://miwisoft.com/support/docs/mijoshop" target="_blank"><img src="http://miwisoft.com/images/support/documentation.png" class="image-css" /></a>
                  <br />
                  <div style="text-align: center;"><a href="http://miwisoft.com/support/docs/mijoshop" target="_blank"><strong>Documentation</strong></a></div>
              </td>
              <td class="column-css">
                  <a href="http://miwisoft.com/support/docs/mijoshop/video-tutorials" target="_blank"><img src="http://miwisoft.com/images/support/videos.png" class="image-css" /></a>
                  <br />
                  <div style="text-align: center;"><a href="http://miwisoft.com/support/docs/mijoshop/video-tutorials" target="_blank"><strong>Video Tutorials</strong></a></div>
              </td>
          </tr>
          <tr>
              <td class="column-css">
