...
// Heading
$_['heading_title']     	  = 'EasySocial Points';

// Text 
$_['text_easysocialpoints']	 = '<img src="view/image/payment/easysocialpoints.png" alt="EasySocial Points" title="EasySocial Points" style="border: 1px solid #EEEEEE;" />';
$_['text_payment']       	 = 'Payment';
$_['text_success']       	 = 'Success: You have modified cheque / money order account details!';
$_['text_edit']              = 'Edit EasySocial Points';
