...
class ModelSaleCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		$data['password'] = MijoShop::get('user')->updateJUserFromO(MijoShop::get('user')->getJUserIdFromOCustomer($customer_id), $data, $customer_id); #mijoshop-start
		...
		if ($data['password']) {
			$this->db->query("UPDATE " . DB_PREFIX . "customer SET password = '" . $data['password'] . "' WHERE customer_id = '" . (int)$customer_id . "'"); #mijoshop-start
		}
	...
	public function deleteCustomer($customer_id) {
		MijoShop::get('user')->deleteJUserFromO($customer_id); #mijoshop-start
	...
	public function approve($customer_id) {
		...
		if ($customer_info) {
            MijoShop::get('user')->approveJUserFromO($customer_id); #mijoshop-start
			...
			$message .= str_replace('/administrator', '', $this->url->link('account/login', '', 'SSL')) . "\n\n"; #mijoshop-start
