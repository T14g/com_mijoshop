...
class ModelUserUserGroup extends Model {
	...
	public function editUserGroup($user_group_id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "jgroup_ugroup_map SET jgroup_id = '" . (int)$data['jgroup_id'] . "' WHERE ugroup_id = '" . (int)$user_group_id . "'"); #mijoshop-start
	...
	public function deleteUserGroup($user_group_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "jgroup_ugroup_map WHERE ugroup_id = '" . (int)$user_group_id . "'"); #mijoshop-start
