...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
        ...
        MijoShop::get('base')->trigger('onMijoshopBeforeProductSave', array(&$data, true)); #mijoshop-start
        #mijoshop-start
        ...
        MijoShop::get('mijosef')->store($data['mijosef'], $product_id); #mijoshop-start
		
        #mijoshop-start
        foreach ($data['keyword'] as $language_id => $value) {
            $keyword = empty($value) ? MijoShop::get('router')->generateAlias($data['product_description'][$language_id]['name']) : $value;
            if ($keyword) {
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterProductSave', array(&$data, &$product_id, true)); #mijoshop-start
	...
	public function editProduct($product_id, $data) {
        ...
        MijoShop::get('base')->trigger('onMijoshopBeforeProductSave', array(&$data, &$product_id, false)); #mijoshop-start
        #mijoshop-start
        foreach($data['product_description'] as $language_id => $value){
            if(empty($value['meta_title'])) {
                $data['product_description'][$language_id]['meta_title'] = $value['name'];
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterProductSave', array(&$data, &$product_id, false)); #mijoshop-start
	}
	...
	public function deleteProduct($product_id) {
        ...
        MijoShop::get('base')->trigger('onMijoshopBeforeProductDelete', array(&$product_id)); #mijoshop-start
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterProductDelete', array(&$product_id)); #mijoshop-start
	}
