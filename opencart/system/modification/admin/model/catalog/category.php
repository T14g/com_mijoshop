...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
        ...
        MijoShop::get('base')->trigger('onMijoshopBeforeCategorySave', array(&$data, true)); #mijoshop-start
        #mijoshop-start
        ...
        MijoShop::get('mijosef')->store($data['mijosef'], $category_id); #mijoshop-start
		
        #mijoshop-start
        foreach ($data['keyword'] as $language_id => $value) {
            $keyword = empty($value) ? MijoShop::get('router')->generateAlias($data['category_description'][$language_id]['name']) : $value;
            if ($keyword) {
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterCategorySave', array(&$data, &$category_id, true)); #mijoshop-start
	...
	public function editCategory($category_id, $data) {
        ...
        MijoShop::get('base')->trigger('onMijoshopBeforeCategorySave', array(&$data, &$category_id, false)); #mijoshop-start
        #mijoshop-start
		foreach($data['category_description'] as $language_id => $value){
            if(empty($value['meta_title'])) {
                $data['category_description'][$language_id]['meta_title'] = $value['name'];
        ...
        MijoShop::get('mijosef')->store($data['mijosef']); #mijoshop-start
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterCategorySave', array(&$data, &$category_id, false)); #mijoshop-start
	}

	public function deleteCategory($category_id) {
		$this->event->trigger('pre.admin.category.delete', $category_id);
        MijoShop::get('base')->trigger('onMijoshopBeforeCategoryDelete', array(&$category_id)); #mijoshop-start
        ...
        MijoShop::get('base')->trigger('onMijoshopAfterCategoryDelete', array(&$category_id)); #mijoshop-start
	}
