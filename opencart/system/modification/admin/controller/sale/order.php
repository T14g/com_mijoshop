...
class ControllerSaleOrder extends Controller {
	...
	public function delete() {
		...
		if (isset($this->session->data['cookie'])) {
			...
			curl_setopt($curl, CURLOPT_COOKIE, $this->session->data['cookie']['name'].'=' . $this->session->data['cookie']['id'] . ';'); #mijoshop-start
	...
	protected function getList() {
		...
		$data['invoice'] = $this->url->link('sale/order/invoice', 'format=raw&tmpl=component&token=' . $this->session->data['token'], 'SSL');#mijoshop-start
		$data['shipping'] = $this->url->link('sale/order/shipping', 'format=raw&tmpl=component&token=' . $this->session->data['token'], 'SSL');#mijoshop-start
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['shipping'] = $this->url->link('sale/order/shipping', 'format=raw&tmpl=component&token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');#mijoshop-start
			$data['invoice'] = $this->url->link('sale/order/invoice', 'format=raw&tmpl=component&token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');#mijoshop-start
...
$this->load->model('tool/upload');
			...
			$data['openbay'] = $this->user->hasPermission('access','extension/openbay');
	...
	public function invoice() {
      ...
      $this->load->model('sale/custom_field');      $custom_fields = $this->model_sale_custom_field->getCustomFields();      
	...
	public function api() {
		...
		if (isset($this->session->data['cookie']) && isset($this->request->get['api'])) {
			...
			$url_data = array();
				...
				if ($this->request->post['view'] == 'admin') { #mijoshop-start
				unset($this->request->post['view']);
			} #mijoshop-end
			foreach ($this->request->get as $key => $value) {
				if ($key != 'route' && $key != 'token' && $key != 'Itemid') { #mijoshop-start
