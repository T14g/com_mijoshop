...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_category_name_limit'] = $this->language->get('entry_category_name_limit'); #mijoshop-start
		...
		$data['help_category_name_limit'] = $this->language->get('help_category_name_limit'); #mijoshop-start
	...
	public function template() {
		if ($this->request->server['HTTPS']) {
			$server = HTTPS_CATALOG.'components/com_mijoshop/opencart/'; #mijoshop-start
		} else {
			$server = HTTP_CATALOG.'components/com_mijoshop/opencart/'; #mijoshop-start
		}
