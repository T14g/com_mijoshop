...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$information_id = $this->model_catalog_information->addInformation($this->request->post); #mijoshop-start
	...
	protected function getForm() {
		...
		if (isset($this->request->post['keyword'])) {
			...
			$data['keyword'] = MijoShop::get('db')->getRecordAliases($this->request->get['information_id'], 'information'); #mijoshop-start
		} else {
			$data['keyword'] = '';
		}
