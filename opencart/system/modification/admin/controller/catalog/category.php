...
class ControllerCatalogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$category_id = $this->model_catalog_category->addCategory($this->request->post); #mijoshop-start
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
              ...
              'status'      => ($result['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')), #mijoshop-start
        ...
        $data['column_status'] = $this->language->get('column_status'); #mijoshop-start
        ...
        $data['sort_status'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL'); #mijoshop-start
	...
	protected function getForm() {
		...
		if (isset($this->request->post['keyword'])) {
			...
			$data['keyword'] = MijoShop::get('db')->getRecordAliases($this->request->get['category_id'], 'category'); #mijoshop-start
		} else {
			$data['keyword'] = '';
		}
