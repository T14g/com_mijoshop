...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$product_id = $this->model_catalog_product->addProduct($this->request->post); #mijoshop-start
	...
	protected function getForm() {
		...
		$data['tab_integration'] = $this->language->get('tab_integration');
		...
		if (isset($this->request->post['keyword'])) {
			...
			$data['keyword'] = MijoShop::get('db')->getRecordAliases($this->request->get['product_id'], 'product'); #mijoshop-start
		} else {
			$data['keyword'] = '';
		}
