...
class ControllerPaymentBraspag5Boleto extends Controller {
	public function index() {
		$this->load->language('payment/braspag5boleto');
	...
	public function uninstall(){
		...
		$this->model_extension_extension->uninstall('payment', 'braspag5boleto');
	}
	public function install() {
		$this->load->model('extension/extension');
		$this->model_extension_extension->install('payment', 'braspag5boleto');
