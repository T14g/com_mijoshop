...
class ControllerPaymentBraspag5Tef extends Controller {
	public function index() {
		$this->load->language('payment/braspag5tef');
	...
	public function uninstall(){
		...
		$this->model_extension_extension->uninstall('payment', 'braspag5tef');
	}
	...
	public function install() {
		$this->load->model('extension/extension');
		$this->model_extension_extension->install('payment', 'braspag5tef');
