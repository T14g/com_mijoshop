...
$data['pedidos_braspag'] = $this->url->link('payment/braspag5', '&pedidos=true&token=' . $this->session->data['token'], 'SSL');
		...
		$data['text_report_customer_search'] = $this->language->get('text_report_customer_search');
		$data['text_report_customer_order'] = $this->language->get('text_report_customer_order');
		...
		$data['report_customer_search'] = $this->url->link('report/customer_search', 'token=' . $this->session->data['token'], 'SSL');
