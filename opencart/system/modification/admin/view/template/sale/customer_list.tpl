  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            ...
            <button type="button" data-toggle="tooltip" title="<?php echo $button_approve; ?>" class="btn btn-success" onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();"><i class="fa fa-thumbs-o-up"></i></button>
...
//--></script></div>
        ...
        function changeStatus(status){
            $.ajax({
                url: 'index.php?route=common/edit/changeStatus&type=customer&status='+ status +'&token=<?php echo $token; ?>',
                dataType: 'json',
