...
<button type="button" data-toggle="tooltip" title="<?php echo $button_fix_lang_ids; ?>" class="btn btn-primary" onclick="fixIds();"><?php echo $button_fix_lang_ids; ?></button>
            <button type="button" data-toggle="tooltip" title="<?php echo $button_lang_sync; ?>" class="btn btn-primary" onclick="fix();" class="button"><?php echo $button_lang_sync; ?></button>
      </div>
