  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
            ...
            <button type="submit" onclick="save('save')" form="form-setting" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
            <button type="submit" form="form-setting" data-toggle="tooltip" title="<?php echo $button_saveclose; ?>" class="btn btn-primary" data-original-title="Save & Close"><i class="fa fa-sign-out"></i></button>
...
<li><a href="#tab-mijoshop" data-toggle="tab">MijoShop</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <input type="hidden" name="config_language" value="en" />
              <input type="hidden" name="config_language" value="en" />
              <div class="form-group">
...
$('select[name=\'config_template\']').on('change', function() {
	$.ajax({
		url: 'index.php?option=com_mijoshop&route=setting/setting/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value),
		dataType: 'html',
		beforeSend: function() {
...
$('select[name=\'config_country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?option=com_mijoshop&route=setting/setting/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
