  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button id="button-send" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_send; ?>" class="btn btn-primary" onclick="sendEmail('index.php?route=marketing/contact/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i></button>
      ...
      <div class="panel-body">
        <form class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <?php echo MijoShop::get('base')->editor()->display("message", "", '97% !important', '320', '50', '11'); ?>
            </div>
          </div>
        </form>
      </div>
...
function sendEmail(url) {
    ...
    <?php echo MijoShop::get('base')->editor()->save("message"); ?>
	// Summer not fix
	$('textarea[name=\'message\']').html(jQuery('textarea[name=\'message\']').val());
