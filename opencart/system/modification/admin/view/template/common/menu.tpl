<ul id="menu">
  <li id="menu-logo">
    <a href="#" onclick="return false;"><i id="button-menu" class="fa fa-indent fa-lg"></i>
      <span>
        <img height="25" src="view/image/logo.png" alt="mijoshop-logo" title="mijoshop-logo" />
...
<li><a href="<?php echo $pedidos_braspag; ?>">Pedidos <?php echo ucfirst($operadora);?></a></li>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
	...
	<?php } ?>
	<?php if( $preturn_customer_online != false || $preturn_customer_activity != false || $preturn_customer_order != false || $preturn_customer_reward != false || $preturn_customer_credit != false || $preturn_customer_search != false ) { ?>
      <li><a class="parent"><?php echo $text_customer; ?></a>
        <ul>
		...
		<?php } ?>
		<?php if($preturn_customer_search) { ?>
          <li><a href="<?php echo $report_customer_search; ?>"><?php echo $text_report_customer_search; ?></a></li>
		<?php } ?>
        </ul>
      </li>
	<?php }?>
