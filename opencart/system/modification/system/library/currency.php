	...
	public function __construct($registry) {
		...
		foreach ($query->rows as $result) {
			$this->currencies[$result['code']] = array(
               ...
               'status'        => $result['status'], #mijoshop-start
				'value'         => $result['value']
			);
		}
       ...
       } elseif (isset($this->request->post['currency_code']) && (array_key_exists($this->request->post['currency_code'], $this->currencies))) { #mijoshop-start
            $this->set($this->request->post['currency_code']); #mijoshop-end
