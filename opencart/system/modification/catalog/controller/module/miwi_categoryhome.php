...
class ControllerModuleMiwiCategoryhome extends Controller {
	...
	public function index($setting) {
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/miwi_categoryhome.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/miwi_categoryhome.tpl'));
        }
        else if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/miwi_categoryhome.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/miwi_categoryhome.tpl', $data));
        }
