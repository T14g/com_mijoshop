...
class ControllerModuleAmazonLogin extends Controller
{
    public function index()
    {
        ...
        if ($this->config->get('amazon_login_pay_status') && $this->config->get('amazon_login_status') && !$this->customer->isLogged() && !empty($this->request->server['HTTPS'])) {
            ...
            if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/amazon_login.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/amazon_login.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/amazon_login.tpl')) {
    ...
    public function login()
    {
        ...
        if ((array) $user) {
            ...
            if ($customer_info) {
                ...
                $customer_id = $this->model_payment_amazon_login_pay->addCustomer($data);
