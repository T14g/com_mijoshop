...
class ControllerPaymentAmazonLoginPay extends Controller
{
    public function address()
    {
        ...
        if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_address.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_address.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_login_pay_address.tpl')) {
    ...
    public function paymentMethod()
    {
        ...
        if ($this->customer->islogged() && isset($this->session->data['lpa']['address'])) {
            $this->model_payment_amazon_login_pay->addAddress($this->session->data['lpa']['address']);
        }
        ...
        if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_payment.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_payment.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_login_pay_payment.tpl')) {
    ...
    public function confirm()
    {
        ...
        if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_confirm.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_confirm.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_login_pay_confirm.tpl')) {
    ...
    public function processOrder()
    {
        ...
        $total = $this->currency->format($order_info['total'], $currency_code, false, false);
        ...
        if ($response['status'] == 'Closed' || $response['status'] == 'Open') {
            $amazon_login_pay_order_id = $this->model_payment_amazon_login_pay->addAmazonOrder($order_info['order_id'], $response['amazon_authorization_id'], $response['capture_status'], $total, $currency_code);

            $this->model_payment_amazon_login_pay->addTransaction($amazon_login_pay_order_id, $response['amazon_authorization_id'], null, 'authorization', $response['status'], $total);

            if (isset($response['amazon_capture_id'])) {
                $this->model_payment_amazon_login_pay->closeOrderRef($amazon_login_pay_order_id);
                $this->model_payment_amazon_login_pay->addTransaction($amazon_login_pay_order_id, $response['amazon_authorization_id'], $response['amazon_capture_id'], 'capture', $response['status'], $total);
            }
    ...
    public function loginFailure()
    {
        ...
        if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_failure.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/amazon_login_pay_failure.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_login_pay_failure.tpl')) {
