...
class ControllerPaymentPaysondirect extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/paysondirect.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/paysondirect.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paysondirect.tpl')) {
        ...
        $error_code = '<html>
                            <head>
                                <script type="text/javascript"> 
                                    ...
                                    window.location="' . (HTTPS_SERVER . 'index.php?option=com_mijoshop&route=checkout/checkout') . '";
                                </script>
                            </head>
                    </html>';
