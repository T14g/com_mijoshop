...
class ControllerPaymentSagepayServer extends Controller {
	public function index() {
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/sagepay_server.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/payment/sagepay_server.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_server.tpl')) {
	...
	public function send() {
		...
		$payment_data['NotificationURL'] = $this->url->link('payment/sagepay_server/callback', '&format=raw&tmpl=component', 'SSL');
