...
class ControllerAccountAddress extends Controller {
	...
	protected function getList() {
      ...
      $this->load->model('account/custom_field');      $account_custom_fields = $this->model_account_custom_field->getCustomFields();      
      ...
      foreach ($result['custom_field'] as $key => $custom_field) {          $account_custom_field_value = $custom_field;          if ($account_custom_fields[$key]['type'] == 'select' || $account_custom_fields[$key]['type'] == 'radio' || $account_custom_fields[$key]['type'] == 'checkbox') {              foreach ($account_custom_fields[$key]['custom_field_value'] as $custom_field_option) {                  if ($custom_field_option['custom_field_value_id'] == $account_custom_field_value) {                      $account_custom_field_value = $custom_field_option['name'];                  }              }          }          $format = str_replace('{custom_field_' . $key . '}', $account_custom_field_value, $format);      }      $format = preg_replace('/(({custom_field(.*?)?}))/sim', '', $format);      
			$find = array(
				'{firstname}',
				'{lastname}',
				'{company}',
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/account/address_list.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/account/address_list.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_list.tpl')) {
	...
	protected function getForm() {
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/account/address_form.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/account/address_form.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_form.tpl')) {
