...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if ($this->request->server['HTTPS']) {
			           $server = HTTPS_IMAGE; #mijoshop
		} else {
			           $server = HTTP_IMAGE; #mijoshop
		}
		...
		// Menu
		if (MijoShop::get('base')->getConfig()->get('show_cats_menu', 0) == 1) {
        ...
        #mijoshop-start
        if (JRequest::getCmd('option') == 'com_mijoshop') {
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/common/header.tpl')) {
            $this->response->setOutput($this->load->view('/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/common/header.tpl', $data));
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/header.tpl')) {
