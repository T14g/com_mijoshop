...
<script type="text/javascript"><!--
	function removeAjaxCart(product_key) {
		if (getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') {
			...
			jQuery('#cart').load('index.php?option=com_mijoshop&route=module/cart&remove='+product_key+' #cart > *');

			jQuery.ajax({
				url: 'index.php?option=com_mijoshop&route=module/cart&remove='+product_key+' #cart > *',
				type: 'post',
